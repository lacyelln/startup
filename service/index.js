...
function updateScore(newScore) {
  ...
  // API route to get all reading posts
apiRouter.get('/reading', (_req, res) => {
    res.send(reading_posts);
  });
  
  // API route to get all writing posts
  apiRouter.get('/writing', (_req, res) => {
    res.send(writing_posts);
  });
  
  // API route to submit a reading post (book review)
